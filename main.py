...
- Press 10 : To exit """)
            ...
            if ch == 1:
                ...
                os.system(
                    "lvcreate --size {}G --name {} {}".format(size, lvn, vgn2))
                ...
                vgn = input("Enter the name of VOLUME GROUP : ")
                lvn = input("Enter the name of LOGICAL VOLUME : ")
                os.system(f"mount /dev/{vgn}/{lvn}  /{user_dir} ")
...
Press 7: to go back to main menu""")
        ...
        if(int(ach3) == 2):
            ...
            os.system(" aws ec2 run-instances --image-id {} --instance-type {} --count {} --subnet-id {} --security-group-ids {} --key-name {} ".format(
                aimgid, ainstancetype, acount, asubnet, asecurity, akey))
            print("\n")
        os.system("tput setaf 7")
        ...
        if(int(ach3) == 4):
            ...
            os.system(
                " aws ec2 start-instances --instance-ids {} ".format(ainstidstart))
            print("\n")
        os.system("tput setaf 7")
        ...
        if(int(ach3) == 5):
            ...
            os.system(
                " aws ec2 stop-instances --instance-ids {} ".format(ainstidstop))
            print("\n")
        os.system("tput setaf 7")
        ...
        if(int(ach3) == 6):
            ...
            os.system(
                " aws ec2 terminate-instances --instance-ids {} ".format(ainstidterm))
            print("\n")
        os.system("tput setaf 7")
...
Press 4: to go back to main menu""")
        ...
        if(int(ach4) == 2):
            ...
            os.system("tput setaf 3")
            os.system(
                " aws ec2 create-volume --availability-zone {} --size {} --volume-type  {}".format(azone, asize, avolume))
            print("\n")
        os.system("tput setaf 7")
        ...
        if(int(ach4) == 3):
            ...
            os.system("tput setaf 3")
            os.system("  aws ec2 attach-volume --device {} --instance-id {} --volume-id {} ".format(
                adevice, ainstanceid, avolumeid))
            print("\n")
        os.system("tput setaf 7")
...
3. Upload file using aws CLI in the terminal.""")
        ...
        if(int(ach5) == 3):
            apath = input(
                "Enter path of your file located in your local device: ")
            abucketname = input("Enter your S3 bucket name: ")
            abucketfolder = input("Enter your S3 bucket folder name: ")
            os.system(
                " aws s3 cp {} s3://{}/{} --acl public-read ".format(apath, abucketname, abucketfolder))
            print("\n")
        os.system("tput setaf 7")
...
Press 10: to go back to main menu""")
        ...
        if(int(ach2) == 9):
            ...
            os.system("tput setaf 3")
            os.system(
                " aws cloudfront create-distribution  --origin-domain-name  {} --default-root-object {} ".format(adomain, aobject))
            print("\n")
        os.system("tput setaf 7")
...
[5]. Go to Docker-Services Menu
        ...
        if int(user_container_choice == 0):
            ...
            os.system(
                "sudo docker run -it --name {} {}:{}".format(container_name, imge_name, imge_version))
...
""")
            ...
            if int(image_delete == 0):
                ...
                os.system(
                    "sudo docker rmi -f {}:{}".format(image_name, image_version))
...
def docker_launch_any_env():
    ...
    os.system("sudo docker run -dit --network host --name {} {}:{}".format(con_name,
                                                                           img_name, img_version))
    os.system(
        "sudo docker exec -it {} yum install {} -y".format(con_name, what_to_install))
...
Press 5: to go back to webserver menu\n""")
            ...
            if int(ch) == 1:
                ...
                os.system("tput setaf 13")
                os.system(
                    "ssh {0}@{1} systemctl start httpd".format(userName, ip))
            elif int(ch) == 3:
                os.system("tput setaf 13")
                os.system("docker pull httpd")
                os.system(
                    "docker run -dit --name my-apache-app -p 8080:80 -v {}:/usr/local/apache2/htdocs/ httpd".format(x))
            elif int(ch) == 4:
                os.system("tput setaf 13")
